    ...
    <div class="px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]">
      ...
      <div class="px-6 sm:px-16 lg:px-24 py-16 fade-in">
        ...
        <div class="relative inline-block mb-7 py-3">
          ...
          <span
            class="absolute left-full top-1/2 transform -translate-y-1/2 ml-3 w-16 border-t-2 border-black"
          ></span>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 items-stretch gap-10">
          ...
          <div class="flex justify-center">
            <img
              class="w-full max-w-sm sm:max-w-md lg:max-w-lg object-cover rounded-lg shadow-lg hover-scale h-full"
          ...
          <!-- Contact Details -->
          <div
            class="bg-gray-100 p-6 rounded-lg shadow-md w-full slide-in flex flex-col justify-center h-full"
          >
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <p class="text-sm sm:text-base">
                  <span class="font-semibold">Tel:</span> +91 98765 43210
                </p>
                <p class="text-sm sm:text-base">
              ...
              <div>
                ...
                <p class="text-sm sm:text-base">
                  <span class="font-semibold">Tel:</span> +91 99876 54321
                </p>
                <p class="text-sm sm:text-base">
                  <span class="font-semibold">Email:</span>
              ...
              <div>
                ...
                <p class="text-sm sm:text-base">
                  <span class="font-semibold">Tel:</span> +91 91234 56789
                </p>
                <p class="text-sm sm:text-base">
                  <span class="font-semibold">Email:</span> surat@pantripick.com
                </p>
              </div>
            </div>
          </div>
